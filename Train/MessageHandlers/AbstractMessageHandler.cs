...
namespace Train.MessageHandlers
{
    public abstract class AbstractMessageHandler
    {
        ...
        public abstract bool Solve(Messages.AbstractMessage am);
        ...
        {
            mhCommSession.SetNext(mhUltimateHandler).SetNext(null);
        }
        //处理接收到的报文
        public static void Handling(Messages.AbstractMessage am)
        {
